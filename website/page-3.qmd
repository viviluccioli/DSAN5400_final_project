...
# Create a scatter plot with larger points and more transparency
scatter = plt.scatter(
    df_elections['tone'], 
    df_elections['afinn_tone_score'],
    alpha=0.6,                           # Slightly increased opacity
    c=df_elections['vader_tone_score'],  # Color points by VADER score
    cmap='coolwarm',                     # Keep the same color scheme
    s=70,                                # Larger point size
    edgecolor='w',                       # White edge for better point visibility
    linewidth=0.5                        # Thin edge
)

# Add a more prominent color bar with a clearer label
cbar = plt.colorbar(scatter, pad=0.02)
cbar.set_label('VADER Score', fontsize=12, fontweight='bold')
cbar.ax.tick_params(labelsize=10)

# Add correlation information in a more visible box
corr_text = plt.annotate(
...
# Add reference lines at 0 with better styling
plt.axhline(y=0, color='gray', linestyle='-', alpha=0.5, linewidth=1.5)
plt.axvline(x=0, color='gray', linestyle='-', alpha=0.5, linewidth=1.5)

# Create a light background for the quadrant labels for better visibility
# Define quadrant boundaries using data ranges
x_max, x_min = df_elections['tone'].max(), df_elections['tone'].min()
y_max, y_min = df_elections['afinn_tone_score'].max(), df_elections['afinn_tone_score'].min()

# Add quadrant labels with better visibility
q1_text = plt.text(x_max*0.7, y_max*0.7, 'Both Positive', 
         fontsize=12, ha='center', fontweight='bold',
         bbox=dict(boxstyle="round,pad=0.3", fc="lightgreen", ec="green", alpha=0.3))

q2_text = plt.text(x_min*0.7, y_max*0.7, 'GDELT Negative\nAFINN Positive', 
         fontsize=11, ha='center', fontweight='bold',
         bbox=dict(boxstyle="round,pad=0.3", fc="lightyellow", ec="orange", alpha=0.3))

q3_text = plt.text(x_max*0.7, y_min*0.7, 'GDELT Positive\nAFINN Negative', 
         fontsize=11, ha='center', fontweight='bold',
         bbox=dict(boxstyle="round,pad=0.3", fc="lightyellow", ec="orange", alpha=0.3))

q4_text = plt.text(x_min*0.7, y_min*0.7, 'Both Negative', 
         fontsize=12, ha='center', fontweight='bold',
         bbox=dict(boxstyle="round,pad=0.3", fc="mistyrose", ec="red", alpha=0.3))

# Add clearer labels and title
plt.xlabel('GDELT Tone Score', fontsize=14, fontweight='bold')
plt.ylabel('AFINN Tone Score', fontsize=14, fontweight='bold')
plt.title('Correlation between GDELT and AFINN Sentiment Scores\nColored by VADER Score', 
          fontsize=16, fontweight='bold', pad=20)

# Add a subtle grid for better readability
plt.grid(True, alpha=0.3, linestyle='-')

# Add tick marks with more space and larger font
...
legend_elements = [
    plt.Line2D([0], [0], marker='o', color='w', markerfacecolor='blue', markersize=10, 
               label='Positive VADER Score'),
    plt.Line2D([0], [0], marker='o', color='w', markerfacecolor='red', markersize=10, 
               label='Negative VADER Score')
]
plt.legend(handles=legend_elements, loc='upper center', 
           bbox_to_anchor=(0.5, -0.08), frameon=True, ncol=2, fontsize=11)

# Add a text explaining the visualization
plt.figtext(0.5, 0.01, 
            "This plot shows the relationship between GDELT and AFINN sentiment scoring systems.\n"
            "Points are colored by VADER sentiment score (blue = positive, red = negative).",
            ha="center", fontsize=10, bbox=dict(boxstyle="round,pad=0.5", fc="white", ec="gray", alpha=0.8))

# Tight layout with adjusted margins to fit all elements
